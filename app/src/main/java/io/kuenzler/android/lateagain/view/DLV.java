...
/**
 * //TODO this as superclass for DepartureDLV and LocationsDLV
 */
public abstract class DLV implements AdapterView.OnItemClickListener {
     ...
     * @param departures
     */
    public DLV(MainActivity main, String[] departures) {
        mMain = main;
        val = departures;
    }
