 ...
 * @date 15.11.03 01:00
 */
public class LocationsDLV implements OnItemClickListener {
     ...
     * @param locations
     */
    public LocationsDLV(MainActivity main, String[] locations, int whichLoc) {
        mMain = main;
        val = locations;
        this.whichLoc = whichLoc;
    }
    ...
    public void showdialog() {
        ...
        listDialog.setTitle("Select Location");
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        listDialog.cancel();
        mMain.setAlternativeLocation(whichLoc, val[arg2]);
    }
}